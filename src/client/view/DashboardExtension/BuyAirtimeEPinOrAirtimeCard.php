...
@build(extra_scope_function_invokation)
    ...
    states.calculateEPinNetPriceUrl = '{! route('api/user/calculate/airtime/card/epin/per/unit/') !}{! $AuthToken !}';
                    ...
                    <div class="iq-appointment1">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="heading-title text-center">
                                    <h2 class="title iq-tw-6"> <i class="fa fa-columns"></i> Airtime E-Pins</h2>
                                    <p></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-lg-8 col-md-8 col-sm-12 iq-mtb-10">
                                ...
                                <p class="text-center w-100" ng-bind-html="states.progress.BuyAirtimeCardEPinFrm"></p>


                                <form id="BuyAirtimeCardEPinFrm" name="BuyAirtimeCardEPinFrm" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-sm-12 iq-mb-10">
                                                <input type="number" value="1" min="1" minlength="1" name="units" ng-model="models.units" class="form-control" id="exampleInputName1" ng-change="calcAirtimeEPinNetPrice($event)" ng-required="true">
                                            </div>
                                    ...
                                    <button class="button btn-block" ng-disabled="!BuyAirtimeCardEPinFrm.$valid" ng-click="buyAirtimeEPin($event)" data-url="{! route('api/user/buy/airtime/epin') !}/{! $AuthToken !}" role="button">Buy</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center">Airtime E-Pin</h5>
            ...
            <div style="" class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-11 p-2">
                        ...
                        <h3 class="col-sm-12">{{ states.AirtimeEPinSold.length }} {{ states.carrier }} PIN List</h3>
                        <div class="col-sm-12 my-2" style="border-bottom: 1px dashed #000;" ng-repeat="p in states.AirtimeEPinSold">
