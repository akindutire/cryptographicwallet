...
@build(scripts_in_head_end)
<script id="mcjs">!function(c,h,i,m,p){m=c.createElement(h),p=c.getElementsByTagName(h)[0],m.async=1,m.src=i,p.parentNode.insertBefore(m,p)}(document,"script","https://chimpstatic.com/mcjs-connected/js/users/00c664789518369a6d5320b2c/4b0c6b8970aa07fc32191625e.js");</script>
@endbuild
                ...
                <div class="col-md-12">
                    ...
                    <div class="example-wrap p-2" style="border: 1px solid #eee; border-radius: 5px;">
                        ...
                        <div class="example" >
                            ...
                            <p class="text-center text-success col-sm-12" ng-bind-html="states.mail_progress_process"></p>

                            <hr class="col-sm-12">

                            <form name="EmailFrm" method="POST" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="inputBasicEmail" ng-model="models.subject" name="subject"
                                           placeholder="Subject" ng-required="true"/>
                                </div>

                                <div class="form-group">
                                    <label class="form-control-label" for="body"><span class="text-danger">*</span>Body</label>
...
<!--                                </div>-->
                                ...
                                <div class="form-group">
                                    <button type="button" ng-click="sendMail($event)" ng-disabled="!EmailFrm.$valid" data-url="{! route('api/user/send-mail') !}" class="btn naijagreen-bg text-light">Send</button>
                                </div>
