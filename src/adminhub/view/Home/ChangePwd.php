...
<head>
  ...
  <!-- Page -->
  <link rel="stylesheet" href="{! uresource('assets/examples/css/pages/forgot-password.min599c.css?v4.0.2') !}">
...
<body class="animsition site-navbar-small page-forgot-password layout-full">
  ...
  <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
      ...
      <form action="{! route('act_changepwd') !}" method="post" role="form">
        {!csrf!}
        <input type="hidden" name="redirect_url" value="{! route('login') !}">
        <input type="hidden" name="RQAUTH" value="{! data('RQAUTH') !}">

        <div class="form-group">
          <input type="password" class="form-control" id="inputEmail" name="password" placeholder="Your Password">
        </div>
        <div class="form-group">
