...
@build('extra_scope_function_invokation')
    states.deleteLinkForCards = '{! route('delete/data/card/') !}';
@endbuild
...
<div class="d-block bg-white">
                ...
                <div data-role="content">
                    ...
                    <div class="page-aside-section">
                        ...
                        <div class="list-group has-actions">
                            ...
                            @foreach( data('card-batch') as $batch )
                                <div class="list-group-item">

                                    <div class="list-content">
                                        <!-- <span class="item-right">10</span> -->
                                        <span class="btn btn-pure btn-icon" style="cursor: pointer;"><i ng-click="EditCardsThroughBatch($event)" data-batch-tag="{! $batch->batch_tag !}" class="icon text-primary fa fa-pencil-square" aria-hidden="true"></i></span>

                                        <span class="btn btn-pure btn-icon mr-1" style="cursor: pointer;"><i ng-click="deleteCardsThroughBatch($event)" data-batch-tag="{! $batch->batch_tag !}" class="icon text-danger fa fa-trash" aria-hidden="true"></i></span>
    ...
    <div class="page-main">
        ...
        <div class="page-header">
            <h1 class="page-title">All Data Card E-Pins</h1>
    ...
    <div class="modal-dialog modal-simple">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Upload Data card(csv)</h4>
            </div>
            <div class="modal-body">
                ...
                <form action="{! route('act_upload_data_card') !}" enctype="multipart/form-data" method="post" id="AddDataCards">
                    ...
                    <div class="form-group">
                        <label class="iq-tw-6 iq-font-black">Price</label>
                        <input type="number" class="form-control" ng-model="models.price" name="price" required />
                    </div>
...
<!-- Add data card Form -->
<div class="modal fade" id="EditDataCardPriceForm" aria-hidden="true" aria-labelledby="EditDataCardPriceForm"
     role="dialog" tabindex="-1">
    <div class="modal-dialog modal-simple">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form action="{! route('act_edit_data_card_price') !}" enctype="multipart/form-data" method="post" id="EditDataCardPriceForm">

                    {! csrf !}


                    <div class="form-group">
                        <label class="iq-tw-6 iq-font-black">Batch</label>
                        <input type="text" class="form-control" ng-model="batchTagForCardEdit" name="batch_tag" required />
                    </div>
