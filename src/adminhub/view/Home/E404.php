...
<head>
  ...
  <!-- Page -->
  <link rel="stylesheet" href="{! uresource('assets/examples/css/pages/errors.min599c.css?v4.0.2') !}">
...
<body class="animsition site-navbar-small page-error page-error-404 layout-full">
  <!--[if lt IE 8]>
  ...
  <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle">
      ...
      <a class="btn btn-primary btn-round" href="{! route('') !}">GO TO HOME PAGE</a>
